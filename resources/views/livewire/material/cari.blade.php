<div class="page-wrapper">
    ...
    <div class="card bg-base-200">
        <form class="w-full text-sm mx-auto card-body" wire:submit.prevent="pencarian">
            ...
            <div class="flex gap-2">
                <input type="search" class="input bg-base-100 input-bordered w-full @error('cari') input-error @enderror"
